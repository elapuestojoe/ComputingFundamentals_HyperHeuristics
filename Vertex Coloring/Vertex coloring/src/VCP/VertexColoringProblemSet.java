 ...
 * @version 1.0
 */
public class VertexColoringProblemSet {
    
    private final VertexColoringProblem[] instances;
     ...
     */
    public VertexColoringProblemSet(String folderName) {
     ...
     */
    public VertexColoringProblemSet(String folderName, Subset type, double proportion, long seed) {
        int i, n;
        ...
        i = 0;
        instances = new VertexColoringProblem[fileNames.size()];
        for (String fileName : fileNames) {
            System.out.print("Loading \'" + folderName + "/" + fileName + "\'...");            
            instances[i++] = new VertexColoringProblem(folderName + "/" + fileName);            
